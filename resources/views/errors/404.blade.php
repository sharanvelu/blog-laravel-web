...
<head>
    ...
    <link rel="icon" href="\res/images/titlebar_logo.png" type="image/x-icon">

    <title>404 Not Found - Sharan'Blog</title>
        ...
        <div class="row">
            <div class="col-md-6 align-self-center">
                ...
                c6.755-0.61,20.546-0.608,41.785,5.087s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"></path>
                        ...
                        <g id="planet" transform="matrix(0.9997,-0.024,0.024,0.9997,-2.4409,13.6636)"
                           style="transform-origin: 0px 0px;">
                            ...
                            <circle id="craterBig" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10"
                                    cx="548.891" cy="62.319" r="13.074" transform="matrix(1,0,0,1,2.06,0)"
                            ...
                            <circle id="craterSmall" fill="none" stroke="#0E0620" stroke-width="3"
                                    ...
                                    transform="matrix(1,0,0,1,-2.06,0)" style="transform-origin: 0px 0px;"></circle>
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149"></path>
                        ...
                        <g id="stars">
                            <g id="starsBig">
                                <g transform="matrix(0.9957,-0.0928,0.0928,0.9957,-21.5271,49.1776)"
                                   style="transform-origin: 0px 0px;">
                                ...
                                <g transform="matrix(0.9856,0.169,-0.169,0.9856,43.1226,-22.6341)"
                                   style="transform-origin: 0px 0px;">
                                    <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                ...
                                <g transform="matrix(0.973,-0.2307,0.2307,0.973,-24.427,77.7255)"
                                   style="transform-origin: 0px 0px;">
                                    <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                ...
                                <g transform="matrix(0.9117,-0.4108,0.4108,0.9117,-185.0981,126.0303)"
                                   style="transform-origin: 0px 0px;">
                                    <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                            ...
                            <g id="starsSmall">
                                ...
                                <g transform="matrix(0.975,0,0,0.9757,5.7867,7.1731)"
                                   style="transform-origin: 0px 0px;">
                                    <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                ...
                                <g transform="matrix(0.873,0,0,0.8733,30.992,69.9027)"
                                   style="transform-origin: 0px 0px;">
                                    <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                ...
                                <g transform="matrix(0.69,0,0,0.6909,57.7711,127.0854)"
                                   style="transform-origin: 0px 0px;">
                                    <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                ...
                                <g transform="matrix(0.428,0,0,0.4285,274.7296,234.9702)"
                                   style="transform-origin: 0px 0px;">
                                    <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                            ...
                            <g id="circlesBig">
                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                        ...
                                        transform="matrix(1,0,0,1,0,-1.373)"
                                        style="transform-origin: 0px 0px;"></circle>
                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                            ...
                            <g id="circlesSmall">
                                <circle fill="#0E0620" cx="549.879" cy="296.402" r="2.651"
                                        transform="matrix(1,0,0,1,0,-2.747)"
                                        style="transform-origin: 0px 0px;"></circle>
                        ...
                        <g id="spaceman" clip-path="url(cordClip)"
                           transform="matrix(0.9999,0.012,-0.012,0.9999,2.6466,0.9927)"
                           style="transform-origin: 0px 0px;">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z"></path>
				...
				M330.868,261.338c-7.929,1.72-15.381,5.246-21.799,10.246"
                                      transform="matrix(0.9999,0.012,-0.012,0.9999,3.167,-3.3397)"
            ...
            <div class="col-md-6 align-self-center">
                ...
                <h2>{{ __('UH OH! Not Found') }}</h2>

                <p>The page you are looking for does not exist or changed to new location.
