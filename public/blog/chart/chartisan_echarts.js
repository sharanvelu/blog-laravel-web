!function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("echarts")) : "function" == typeof define && define.amd ? define(["exports", "echarts"], e) : e((t = t || self)["@chartisan/echarts"] = {}, t.echarts)
}(this, (function (t, e) {
    "use strict";
    /*! *****************************************************************************
    ...
    function v(t, e, n) {
        (n = n || {}).arrayMerge = n.arrayMerge || d, n.isMergeableObject = n.isMergeableObject || u, n.cloneUnlessOtherwiseSpecified = h;
        ...
        return r === Array.isArray(t) ? r ? n.arrayMerge(t, e, n) : function (t, e, n) {
            ...
            return n.isMergeableObject(t) && p(t).forEach((function (e) {
                ...
                })(t, o) || (f(t, o) && n.isMergeableObject(e[o]) ? r[o] = function (t, e) {
    ...
    var y, g, b = ["#667EEA", "#F56565", "#48BB78", "#ED8936", "#9F7AEA", "#38B2AC", "#ECC94B", "#4299E1", "#ED64A6"],
        m = v, w = {
            general: function (t) {
                var e = t.size, n = t.color;
            ...
            bar: function (t) {
                var e = t.size, n = t.color;
                return '\n    <svg width="' + e[0] + '" height="' + e[1] + '" viewBox="0 0 135 140" xmlns="http://www.w3.org/2000/svg" fill="' + n + '">\n        <rect y="10" width="15" height="120" rx="6">\n            <animate attributeName="height"\n                begin="0.5s" dur="1s"\n                values="120;110;100;90;80;70;60;50;40;140;120" calcMode="linear"\n                repeatCount="indefinite" />\n            <animate attributeName="y"\n                begin="0.5s" dur="1s"\n                values="10;15;20;25;30;35;40;45;50;0;10" calcMode="linear"\n                repeatCount="indefinite" />\n        </rect>\n        <rect x="30" y="10" width="15" height="120" rx="6">\n            <animate attributeName="height"\n                begin="0.25s" dur="1s"\n                values="120;110;100;90;80;70;60;50;40;140;120" calcMode="linear"\n                repeatCount="indefinite" />\n            <animate attributeName="y"\n                begin="0.25s" dur="1s"\n                values="10;15;20;25;30;35;40;45;50;0;10" calcMode="linear"\n                repeatCount="indefinite" />\n        </rect>\n        <rect x="60" width="15" height="140" rx="6">\n            <animate attributeName="height"\n                begin="0s" dur="1s"\n                values="120;110;100;90;80;70;60;50;40;140;120" calcMode="linear"\n                repeatCount="indefinite" />\n            <animate attributeName="y"\n                begin="0s" dur="1s"\n                values="10;15;20;25;30;35;40;45;50;0;10" calcMode="linear"\n                repeatCount="indefinite" />\n        </rect>\n        <rect x="90" y="10" width="15" height="120" rx="6">\n            <animate attributeName="height"\n                begin="0.25s" dur="1s"\n                values="120;110;100;90;80;70;60;50;40;140;120" calcMode="linear"\n                repeatCount="indefinite" />\n            <animate attributeName="y"\n                begin="0.25s" dur="1s"\n                values="10;15;20;25;30;35;40;45;50;0;10" calcMode="linear"\n                repeatCount="indefinite" />\n        </rect>\n        <rect x="120" y="10" width="15" height="120" rx="6">\n            <animate attributeName="height"\n                begin="0.5s" dur="1s"\n                values="120;110;100;90;80;70;60;50;40;140;120" calcMode="linear"\n                repeatCount="indefinite" />\n            <animate attributeName="y"\n                begin="0.5s" dur="1s"\n                values="10;15;20;25;30;35;40;45;50;0;10" calcMode="linear"\n                repeatCount="indefinite" />\n        </rect>\n    </svg>\n'
            }
        }, O = function (t) {
            return '\n    <div class="chartisan-help-block">\n        ' + $[t.type](t) + "\n        " + ("" == t.text ? "" : '\n                <div class="chartisan-help-text" style="color: ' + t.textColor + ';">\n                    ' + t.text + "\n                </div>") + "\n    </div>\n"
        };
    (g = y || (y = {})).Initializing = "initializing", g.Loading = "loading", g.Error = "error", g.Show = "show";
    var E = function () {
        function t(t) {
            this.options = {
                el: ".chartisan",
        ...
        return t.prototype.setModal = function (t) {
            var e = t.show, n = void 0 === e || e, r = t.color, o = void 0 === r ? "#FFFFFF" : r, i = t.content;
            this.modal.style.backgroundColor = o, this.modal.style.display = n ? "flex" : "none", i && (this.modal.innerHTML = i)
        }, t.prototype.changeTo = function (t, e) {
            switch (t) {
                case y.Initializing, y.Loading:
                    this.setModal({show: !0, content: O(this.options.loader)});
                    break;
                case y.Show:
                ...
                case y.Error:
                    this.setModal({
                        show: !0,
                        content: x(this.options.error, null != e ? e : new Error("Unknown Error"))
                    }), this.refreshEvent()
            }
            this.cstate = t
            ...
            var e = this;
            return this.options.url ? void fetch(this.options.url, this.options.options).then((function (t) {
                return t.json()
            })).then((function (n) {
            ...
            var e, n, r, o, a, s, c;
            if ((null === (e = t) || void 0 === e ? void 0 : e.url) && (this.options.url = t.url), (null === (n = t) || void 0 === n ? void 0 : n.options) && (this.options.options = t.options), null === (r = t) || void 0 === r ? void 0 : r.data) {
                var u = void 0;
                i(t.data) ? u = t.data : ((null === (o = t) || void 0 === o || !o.background) && this.changeTo(y.Loading), u = t.data());
                var l = this.getDataFrom(u);
                return this.changeTo(y.Show), t.background ? this.onBackgroundUpdate(l, null === (a = t) || void 0 === a ? void 0 : a.additional) : this.onUpdate(l, null === (s = t) || void 0 === s ? void 0 : s.additional)
            }
            (null === (c = t) || void 0 === c ? void 0 : c.background) || this.changeTo(y.Loading), this.request(t)
            ...
            if (this.options.hooks) try {
                ...
                }(this.options.hooks.hooks), i = o.next(); !i.done; i = o.next()) r = (0, i.value)({
                    data: r,
                    merge: m,
                    server: t
                })
            ...
            this.changeTo(y.Show), (null === (n = e) || void 0 === n ? void 0 : n.background) ? this.onBackgroundUpdate(a, null === (r = e) || void 0 === r ? void 0 : r.additional) : this.onUpdate(a, null === (o = e) || void 0 === o ? void 0 : o.additional)
    ...
    function C(t, e) {
        var n, r, o, i;
        return t ? Array.isArray(t) ? null != (r = null === (n = t[0].data) || void 0 === n ? void 0 : n[e]) ? r : "" : null != (i = null === (o = t.data) || void 0 === o ? void 0 : o[e]) ? i : "" : ""
    }
    ...
    var T = function (t) {
        ...
        return r(e, t), e.prototype.title = function (t) {
            return this.options({title: "string" == typeof t ? {text: t} : t})
        }, e.prototype.axis = function (t) {
            return void 0 === t && (t = !0), this.options(o({}, "boolean" == typeof t ? t = {
                xAxis: {show: t},
                yAxis: {show: t}
            } : t))
        }, e.prototype.legend = function (t) {
            return void 0 === t && (t = !0), this.options({legend: "boolean" == typeof t ? {show: t} : t})
        }, e.prototype.tooltip = function (t) {
            return void 0 === t && (t = !0), this.options({tooltip: "boolean" == typeof t ? {show: t} : t})
            ...
            return this.custom((function (e) {
                var n, r, o = e.data, i = e.merge, a = Array.isArray(t) ? t.map((function (t) {
                    return "string" == typeof t ? {type: t} : t
                })) : [{type: t}];
                if (o.series) for (var s = 0; s < o.series.length; s++) o.series[s] = i(o.series[s], a[s % a.length]), "pie" == a[s % a.length].type && (o.series[s].data = null === (r = null === (n = o.series[s]) || void 0 === n ? void 0 : n.data) || void 0 === r ? void 0 : r.map((function (t, e) {
                    return {value: t, name: C(o.xAxis, e)}
                })));
                return o
            }))
        }, e
    ...
    var R = j((function (t, e) {
        ...
        var n = [], r = function () {
            function t(t) {
                ...
                var e = function (t) {
                    if (void 0 === t) return "Failed to construct 'ResizeObserver': 1 argument required, but only 0 present.";
            ...
            return t.prototype.observe = function (t) {
                var e = o("observe", t);
                if (e) throw TypeError(e);
                i(this.$$observationTargets, t) > 0 || (this.$$observationTargets.push(new z.ResizeObservation(t)), h())
        ...
        function o(t, e) {
            return void 0 === e ? "Failed to execute '" + t + "' on 'ResizeObserver': 1 argument required, but only 0 present." : e instanceof window.Element ? void 0 : "Failed to execute '" + t + "' on 'ResizeObserver': parameter 1 is not of type 'Element'."
        }
        ...
        var a, s = function (t) {
            n.forEach((function (e) {
                e.$$activeTargets = [], e.$$skippedTargets = [], e.$$observationTargets.forEach((function (n) {
                    n.isActive() && (u(n.target) > t ? e.$$activeTargets.push(n) : e.$$skippedTargets.push(n))
                }))
            }))
        }, c = function () {
            var t = 1 / 0;
            return n.forEach((function (e) {
                if (e.$$activeTargets.length) {
                    ...
                    e.$$activeTargets.forEach((function (e) {
                        ...
                        n.push(r), e.$$broadcastWidth = r.contentRect.width, e.$$broadcastHeight = r.contentRect.height;
                        var o = u(e.target);
                        o < t && (t = o)
                    })), e.$$callback(n, e), e.$$activeTargets = []
                }
            })), t
        }, u = function (t) {
            ...
            })) && (t = new window.ErrorEvent("ResizeLoopError", {message: "ResizeObserver loop completed with undelivered notifications."}), window.dispatchEvent(t))
        }, h = function () {
            a || d()
        }, d = function () {
    ...
    k(R);
    var F = R.ResizeObserver, S = R.install, _ = function (t) {
        function n() {
            return null !== t && t.apply(this, arguments) || this
        }
        ...
        return r(n, t), n.prototype.observe = function () {
            var t = this;
            this.observer && this.observer.disconnect(), this.observer = new F((function () {
                var e;
                return null === (e = t.chart) || void 0 === e ? void 0 : e.resize()
            })), this.div && this.observer.observe(this.div)
        }, n.prototype.renewDiv = function () {
            this.div && this.body.removeChild(this.div), this.div = document.createElement("div"), this.div.style.width = "100%", this.div.style.height = "100%", this.body.appendChild(this.div), this.observe()
        }, n.prototype.formatData = function (t) {
            return {
                xAxis: {data: t.chart.labels}, yAxis: {}, series: t.datasets.map((function (t) {
                    return {name: t.name, type: "bar", data: t.values}
                }))
            }
        }, n.prototype.onUpdate = function (t) {
            this.chart && this.chart.dispose(), this.renewDiv(), this.chart = e.init(this.div), this.chart.setOption(t)
    ...
    "undefined" != typeof window && (window.hasOwnProperty("ResizeObserver") || S(), window.Chartisan = _, window.ChartisanHooks = T), t.Chartisan = _, t.ChartisanHooks = T, Object.defineProperty(t, "__esModule", {value: !0})
}));
